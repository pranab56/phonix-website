...
const ProfileBanner = () => {
  ...
  return (
    <div className={`pt-20 pb-10 ${isDarkMode ? 'bg-gray-800' : 'bg-[#EBEBFF]'}`}>
          ...
          <div className="relative pt-10 pb-4 px-4 sm:px-6">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 -top-12">
              <div className="relative">
                <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-600' : 'bg-gray-300'}`}>
                  <img
            ...
            <div className="text-center">
              ...
              <p className={`text-sm sm:text-base mt-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>
      ...
      {/* Edit Profile Modal */}
      <Modal
        title={<span className={isDarkMode ? 'text-white' : ''}>Edit Profile Information</span>}
        open={isModalOpen}
      ...
      >
        ...
        >
          <Form.Item label={<span className={isDarkMode ? 'text-white' : ''}>Profile Picture</span>}>
            <Row gutter={[16, 16]} align="middle">
                ...
                <Col xs={24} sm={8} md={6}>
                  <div className="flex justify-center">
                    <img
                      src={getImageUrl(data?.data?.profile)}
                      alt="Current profile"
                      className={`w-16 h-16 sm:w-20 sm:h-20 object-cover rounded-full ${isDarkMode ? 'border border-gray-500' : ''}`}
                    />
                  </div>
              ...
              <Col xs={24} sm={16} md={18}>
                <Upload {...uploadProps}>
                  {fileList.length === 0 && (
                    <div className={`p-2 sm:p-4 rounded-lg ${isDarkMode ? 'bg-gray-600' : 'bg-gray-50'}`}>
                      <PlusOutlined className={isDarkMode ? 'text-white' : ''} />
                      <div className={`mt-2 ${isDarkMode ? 'text-white' : ''}`}>
          ...
          >
            <Input
              disabled
              className={isDarkMode ? 'bg-gray-600 text-gray-300 border-gray-500' : ''}
              size={isMobile ? 'middle' : 'large'}
            />
          </Form.Item>
